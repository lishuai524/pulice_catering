...
<script>
    ...
    layui.use(['form','table'], function(){
        ...
        table.render({
            elem: '#test'
            ,url:'/order_management/order-management/queryAll.do'
            ,cols: [
                [
                    {field:'order_reference', width:'7%', title: '订单编号', sort: true}
                    ,{field:'ldid', width:'7%', title: '桌号'}
                    ,{field:'name', width:'7%', title: '姓名'}
                    ,{field:'cell_phone_number', width:'7%', title: '预留手机号'}
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('真的删除行么', function(index){
                    $.get({
                        url:"/order_management/order-management/delete/"+data.id+".do",
                ...
                layer.open({
                    ...
                    offset:"100px",
                    fixed:true,
                    content: "/order_management/order-management/toupdate/"+data.id+".do",
