...
<form class="layui-form layui-form-pane" action="/reserve_tables_list/reserve-tables-list/update.do"  method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="name" value="${res.name}" lay-verify="required" placeholder="请输入姓名" autocomplete="off" class="layui-input" >
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="people" value="${res.people}" lay-verify="number" placeholder="请输入数字" autocomplete="off" class="layui-input" >
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="reserved" value="${res.reserved}" lay-verify="required|phone|number"  placeholder="请输入手机号" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="order_date" value="${res.order_date}" id="date1" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="qsid" lay-filter="aihao" id="sele">
                ...
                <c:forEach items="${list}" var="i">
                    <option value="${i.osid}" ${i.osid eq res.qsid ? 'selected':''}>${i.name}</option>
                </c:forEach>
            </select>
        </div>
    </div>
