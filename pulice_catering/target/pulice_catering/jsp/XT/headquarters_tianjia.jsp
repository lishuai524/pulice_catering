...
<form class="layui-form" onsubmit="return false">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="job_number" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input" readonly>
            <button class="layui-btn layui-btn-normal">选择员工</button>(*必填项)
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="mobile_phone" placeholder="请输入" class="layui-input" readonly>
            <button class="layui-btn layui-btn-normal">选择地址</button>
        </div>
    </div>
    <div class="layui-form-item">
