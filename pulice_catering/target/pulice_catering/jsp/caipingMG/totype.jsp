...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
    <legend>菜品类别修改</legend>
</fieldset>

<form class="layui-form" action="/caipingtype/update.do" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="type" value="${list.type}" lay-verify="required" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
