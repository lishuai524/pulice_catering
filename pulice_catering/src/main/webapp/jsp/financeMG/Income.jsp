...
<div class="layui-tab">
    ...
    <div class="layui-tab-content">
        ...
        <div class="layui-tab-item" >
            <iframe height="88%" width="98%" src="ewaiinsert.jsp"></iframe>
        </div>
    </div>
</div>
...
<script>
    layui.use(['table','form','element'], function () {
        ...
        table.render({
            elem:'#test'
            ,url:'/ewai/queryAll.do'
            ,toolbar:'#toolbarDemo'
            ,title:'交接表'
            ,cols:[[
                {field:'name', title:'名称', width:'25%', edit: 'text'}
                ,{field:'money', title:'金额', width:'25%'}
                ,{field:'test', title:'备注', width:'25%'}
        ...
        table.on('tool(test)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('真的删除行么', function(index){
                    $.get("/ewai/delect.do?id="+data.id,function(data,status){
                ...
                layer.open({
                    type: 2,
                    area: ['700px', '600px'],
                    content:'/ewai/queryByID.do?id='+data.id,
